...
unsigned char fila=0xFF, col=0xFF;
volatile unsigned char flag_kb,delay_kb;
...
if ((PORTBbits.RB4 && PORTBbits.RB5 && PORTBbits.RB6 && PORTBbits.RB7)&&(!delay_kb)) status_KB = KB_LIBRE;
break;
