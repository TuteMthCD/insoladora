...
data = (unsigned int)(porcentaje * 200) / 100;
pwm_set(200, data);
}

void aspiradora (unsigned char est_asp){
TRISAbits.TRISA2 = 0;;
if(est_asp)PORTAbits.RA2 = 0x1;
else PORTAbits.RA2 = 0x0;
}
void luces (unsigned char est_luces){
TRISAbits.TRISA3 = 0;;
if(est_luces)PORTAbits.RA3 = 0x1;
else PORTAbits.RA3 = 0x0;
}
