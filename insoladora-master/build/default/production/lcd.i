...
mensaje[0] = ((segundos / 10) % 10) + 48;
mensaje[1] = (segundos % 10) + 48;
mensaje[2] = 58;
mensaje[3] = ((minutos / 10) % 10) + 48;
mensaje[4] = (minutos % 10) + 48;
...
Crear_Caracter(varFlecha, 0x40 + 0x00);
ret_HOME();
