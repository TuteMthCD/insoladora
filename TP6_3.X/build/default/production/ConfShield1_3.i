...
unsigned char Botones13() {
    ...
    switch (Estado_BOT) {
        case BotonLibre:
            if (!PORTDbits.RD4 || !PORTDbits.RD5 || !PORTDbits.RD6 || !PORTDbits.RD7) {
        ...
        case BotonEnEspera:
            ...
            break;
        case BotonDetectado:
            if (!PORTDbits.RD7)Boton_Presionado = 4;
            else if (!PORTDbits.RD6)Boton_Presionado = 3;
            else if (!PORTDbits.RD5)Boton_Presionado = 2;
            else if (!PORTDbits.RD4)Boton_Presionado = 1;
            else Boton_Presionado = 0;;
        ...
        case BotonEsperaLiberarce:
            if (PORTDbits.RD4 && PORTDbits.RD5 && PORTDbits.RD6 && PORTDbits.RD7 && !bot_tout) Estado_BOT = BotonLibre;
            break;
        default:
            Boton_Presionado = 0;;
