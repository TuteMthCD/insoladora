...
# 2 "<built-in>" 2
# 1 "EncoderIncremental.c" 2


# 1 "./EncoderIncremental.h" 1
...
void encoderIni(unsigned char setMAX, unsigned char setMin){
    maximoEncoder = setMAX;
    minimoEncoder = setMin;
